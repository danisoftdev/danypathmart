...
Most people apply at https://danypathmart.store/sell. You fill in your business details, contact phones (including a customer service or WhatsApp number customers can call), address, and how you want to receive money (for example bank or MoMo details for your records). You must accept the Terms, Privacy Policy, and Shop Seller Policy before you submit.

If DPM invited you, you will open a special link like /sell?invite=… . That link may pre-fill some fields. You still log in with your own account email — that same login becomes your seller dashboard login after approval.

Sometimes a registration fee is required when you apply (if billing is turned on and you are not on a free period or waiver). You pay that fee to DPM through Paystack. After that, DPM reviews your application. When you are approved, your shop is created and you can sign in at /seller with the same account.
...
https://danypathmart.store/stores/your-shop-slug

Share this link with customers — on WhatsApp, Instagram, flyers, or anywhere you market. This is where they browse your products and check out.

Do not tell customers to buy your items from the main DPM shop at /shop. Your items live on your store link. The cart on your link is for your shop only. Customers cannot mix your products with DPM’s own catalog or another shop’s products in the same cart on that link.
...
From the seller menu you can:

• Overview — a snapshot of your shop and tools to share your link
• Products — add and edit what you sell
• Orders — see new orders, mark payments received, and update delivery status
• Live chat — reply when customers message your shop
• Billing — pay and manage your subscription
• Payouts / Payments — choose how customers pay you (cash, MoMo, Paystack)
• Settings / Profile — shop name, phones, pickup, map pin, storefront privacy, and bank/MoMo details
...
When it is nearly due, you should get reminders by email and in the dashboard — typically about 7 days before, 1 day before, and on the day it expires. Open Seller → Billing to see your current period, pay renewal (monthly or yearly, depending on what DPM offers), turn auto-renew on or off if that option is available, and download or print receipts for fees you have paid.

If the subscription lapses, customers lose access to your public link until you renew. Your seller login still works so you can pay and reopen the storefront.
...
Pay in person: The customer pays you in cash or by MoMo when they collect or when you deliver. The order appears as “Awaiting payment” until you confirm you have received the money.

Mobile money (manual): Your MoMo number is shown for the customer to pay offline. When the money hits your phone, go to Orders and mark that order as paid. Do not mark paid until you have actually received it.

Paystack (online): The customer pays online (card or MoMo through Paystack). Money goes to your Paystack subaccount, not into a DPM holding wallet. To use this, your shop usually needs to be verified by DPM and you must enter your Paystack subaccount code (it looks like ACCT_…). Until that is set up, keep MoMo or pay-in-person available so customers can still order.
...
For each product you can set the name, price in Ghana Cedis (GHS), how many you have in stock, category, description, and images (up to five). You can also add a short promo badge (for example “New”, “Sale”, or your own short label) and mark “free delivery” if you are offering that yourself — that badge is a promise from your shop, not a delivery arranged by DPM.

New products you create are typically published live on your store link right away. Keep descriptions, prices, and stock honest. If DPM ever unpublishes a listing (for example because something looked wrong), you will see a note; editing and fixing the product can put it back live according to the platform rules.

There is no special “pre-order” or air-freight mode for marketplace shops — sell what you can fulfil from stock you control.
...
If the customer paid with Paystack, payment is confirmed automatically. You can start preparing the order.

If they chose MoMo or pay in person, the order starts as Awaiting payment. Contact the customer if needed, wait until you receive the money, then use Mark as paid. Only then should you pack and send.

After payment is confirmed, move the order through the statuses in order:

Preparing — you are packing or getting the item ready
Out for delivery — it is on the way (or you are arranging handover)
Delivered — the customer has received it

You can add a short note for the customer when you update status. Do not skip ahead while the order is still awaiting payment, cancelled, or already delivered.
...
Customers can also message through DPM’s live chat when their conversation is routed to your shop. Open Seller → Live chat (or the shop chat icon in the seller area) and reply with text or images. Answer promptly — good communication prevents disputes.
...
☐ Products are listed with correct prices, stock, and clear photos
☐ Customer service phone or WhatsApp is filled in on your profile
☐ You have tested ordering on your own /stores/… link
☐ You know how to Mark as paid for MoMo and cash orders
...
Complaints & Disputes — /policies/complaints-disputes
Terms of Service — /policies/terms
Privacy Policy — /policies/privacy
Acceptable Use — /policies/acceptable-use

Seller dashboard — https://danypathmart.store/seller
Apply to sell — https://danypathmart.store/sell

If something in this handbook does not match what you see on the site, contact DPM support through the main Contact page and we will help clarify.
