...
$routes = [
    ...
    'POST ' . 'admin/products/reset-stock' => 'admin/products/reset-stock.php',
    ...
    'POST ' . 'admin/pos/barcodes/backfill'   => 'admin/pos/barcodes/backfill.php',
    'GET '  . 'admin/pos/labels'              => 'admin/pos/labels/index.php',
    'GET '  . 'admin/pos/shifts/history'       => 'admin/pos/shifts/history.php',
    ...
    'POST ' . 'public/platform-feedback'  => 'public/platform-feedback.php',
    'GET '  . 'public/push/vapid'         => 'public/push/vapid.php',
    'POST ' . 'public/push/subscribe'     => 'public/push/subscribe.php',
    'GET '  . 'public/shops'              => 'public/shops/index.php',
    ...
    'GET '  . 'shop/billing'                   => 'shop/billing/index.php',
    'GET '  . 'shop/billing/receipt'           => 'shop/billing/receipt.php',
    'POST ' . 'shop/billing/auto-renew'        => 'shop/billing/auto-renew.php',
    'GET '  . 'shop/billing/payment-methods'   => 'shop/billing/payment-methods.php',
    'POST ' . 'shop/billing/payment-methods'   => 'shop/billing/payment-methods.php',
    'DELETE ' . 'shop/billing/payment-methods' => 'shop/billing/payment-methods.php',
    'GET '  . 'shop/products'               => 'shop/products/index.php',
    'POST ' . 'shop/products'               => 'shop/products/create.php',
    'POST ' . 'shop/products/reset-stock'   => 'shop/products/reset-stock.php',
    ...
    'GET '  . 'users/account/deletion'      => 'users/account/deletion.php',
    'POST ' . 'users/account/deletion'      => 'users/account/deletion.php',
    ...
    'GET '  . 'public/availability'         => 'public/availability.php',
