...
if (!tableExists($pdo, 'kit_templates')) {
    $pdo->exec(
    ...
    echo "created kit_templates\n";
}

if (!tableExists($pdo, 'kit_template_items')) {
    $pdo->exec(
    ...
    echo "created kit_template_items\n";
}

echo "Phase D kit builder migration complete.\n";
