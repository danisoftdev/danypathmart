...
try {
    $received = HubLogisticsService::receiveAtHub($pdo, $orderIds, (int) $admin['id'], $note !== '' ? $note : null);
} catch (\InvalidArgumentException $e) {
    Response::error($e->getMessage(), 422);
}

Response::success([
    'message'     => count($received) > 0 ? 'Orders marked received at hub.' : 'No orders were updated.',
    'received'    => $received,
