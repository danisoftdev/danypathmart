...
try {
    ...
    $updated = StationRepackService::completeRepack(
        $pdo,
        $orderIds,
        $stationId,
        (int) $staff['id'],
        isset($body['bag_label']) ? (string) $body['bag_label'] : null,
...
Response::success([
    'message'        => count($updated) > 0 ? 'Orders repacked and ready for pickup.' : 'No orders were updated.',
    'updated'        => $updated,
